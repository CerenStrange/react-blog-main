...
export default function App() {
 const userName="Çelik"
 const users=["meraklı", "çılgın", "Resim Sever", "matematk delisi"]
 const isActive= true
  return (
    <div>
     <div class="container-fluid p-5 bg-primary text-white text-center">
  <h1>Ceren {userName}</h1>
...
<div class="container mt-5">
  <div class="row">
    <div class="col-sm-4">
      ...
      <p>Ben Ertuğrul Gazi Anadolu Lisesi 2022 mezunuyum.Yeni şeyler öğrenmeye ve becerilerimi gelistirmeye çok önem veriyorum. Bu sebepten ötürü Üretken Akademi ve Bursa Büyükşehir Belediyesi ortaklığında gerceklesen eğitimine başvurdum ve eğitimi almaya hak kazandım. Suanda HTML, CSS, JavaScript ve React eğitimlerini alıyorumç   </p>
